...
contract Cre8orBuilderRewards is
    ERC721A,
    Cre8iveAdmin,
    IERC2981,
    ReentrancyGuard,
    ...
    ERC721DropStorageV1
{
        ...
        Cre8iveAdmin(_initialOwner)
    {
        ...
        config.editionSize = type(uint64).max;
        config.metadataRenderer = _metadataRenderer;
        config.royaltyBPS = 808;
        config.fundsRecipient = _fundsRecipient;
        burnConfig.burnToken = _burnToken;
        burnConfig.burnQuantity = _burnQuantity;
    }
