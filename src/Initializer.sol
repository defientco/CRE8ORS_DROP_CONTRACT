...
contract Initializer {
    ...
    function setup(
        ...
        IAccessControl(_target).grantRole(MINTER_ROLE, _familyAndFriendsMinter);
        IAccessControl(_target).grantRole(MINTER_ROLE, _collectionHolderMinter);
        IAccessControl(_target).grantRole(MINTER_ROLE, _allowlistMinter);
        IAccessControl(_target).grantRole(MINTER_ROLE, _publicMinter);
    }
